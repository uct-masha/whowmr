...
The package also includes a function `download_whowmr_reports(years=2017:2024, outdir='.')` to download PDF copies of the World Malaria Reports for the specified years. The reports are downloaded and saved in the specified output directory.
