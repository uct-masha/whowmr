...
get_wmr2018 <- function() {
  ...
  ## WMR2018A Assertions: ####
  check_who_dataframe(df = wmr2018a,
                      rows = 94,
                      cols = 18,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2018B Assertions: ####
  check_who_dataframe(df = wmr2018b,
                      rows = 95,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2018C Assertions: ####
  check_who_dataframe(df = wmr2018c,
                      rows = 279,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2018D Assertions: ####
  check_who_dataframe(df = wmr2018d,
                      rows = 288,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2018E Assertions: ####
  check_who_dataframe(df = wmr2018e,
                      rows = 25,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 3,
  ...
  ## WMR2018F Assertions: ####
  check_who_dataframe(df = wmr2018f,
                      rows = 872,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2018G Assertions: ####
  check_who_dataframe(df = wmr2018g,
                      rows = 92,
                      cols = 12,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2018H Assertions: ####
  check_who_dataframe(df = wmr2018h,
                      rows = 624,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2018I Assertions: ####
  check_who_dataframe(df = wmr2018i,
                      rows = 520,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2018J Assertions: ####
  check_who_dataframe(df = wmr2018j,
                      rows = 104,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 6,
