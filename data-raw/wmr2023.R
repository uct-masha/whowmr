...
get_wmr2023 <- function() {
  ...
  check_who_dataframe(df = wmr2023_2,
                      rows = 64,
                      cols = 16,
                      unique_values = list(
                        `Country` = 64,
  ...
  ## WMR2023A Assertions: ####
  check_who_dataframe(df = wmr2023a,
                      rows = 87,
                      cols = 19,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2023B Assertions: ####
  check_who_dataframe(df = wmr2023b,
                      rows = 90,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2023C Assertions: ####
  check_who_dataframe(df = wmr2023c,
                      rows = 279,
                      cols = 17,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2023D Assertions: ####
  check_who_dataframe(df = wmr2023d,
                      rows = 270,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2023ea,
                      rows = 31,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 3,
  ...
  check_who_dataframe(df = wmr2023eb,
                      rows = 21,
                      cols = 27,
                      unique_values = list(
                        `WHO Region` = 1,
  ...
  ## WMR2023F Assertions: ####
  check_who_dataframe(df = wmr2023f,
                      rows = 2484,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2023G Assertions: ####
  check_who_dataframe(df = wmr2023g,
                      rows = 88,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2023H Assertions: ####
  check_who_dataframe(df = wmr2023h,
                      rows = 792,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2023I Assertions: ####
  check_who_dataframe(df = wmr2023i,
                      rows = 582,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2021J Assertions: ####
  check_who_dataframe(df = wmr2023j,
                      rows = 95,
                      cols = 15,
                      unique_values = list(
                        `WHO Region` = 5,
