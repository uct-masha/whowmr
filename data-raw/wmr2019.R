...
get_wmr2019 <- function() {
  ...
  ## WMR2019A Assertions: ####
  check_who_dataframe(df = wmr2019a,
                      rows = 93,
                      cols = 19,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2019B Assertions: ####
  check_who_dataframe(df = wmr2019b,
                      rows = 96,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2019C Assertions: ####
  check_who_dataframe(df = wmr2019c,
                      rows = 279,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2019D Assertions: ####
  check_who_dataframe(df = wmr2019d,
                      rows = 288,
                      cols = 9,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2019ea,
                      rows = 35,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 4,
...
,
  ...
  check_who_dataframe(df = wmr2019eb,
                      rows = 20,
                      cols = 27,
                      unique_values = list(
...
,
  ...
  ## WMR2019G Assertions: ####
  check_who_dataframe(df = wmr2019g,
                      rows = 92,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2019H Assertions: ####
  check_who_dataframe(df = wmr2019h,
                      rows = 619,
                      cols = 13,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2019I Assertions: ####
  check_who_dataframe(df = wmr2019i,
                      rows = 492,
                      cols = 12,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2019J Assertions: ####
  check_who_dataframe(df = wmr2019j,
                      rows = 104,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 6,
