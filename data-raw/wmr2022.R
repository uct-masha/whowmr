...
get_wmr2022 <- function() {
  ...
  check_who_dataframe(df = wmr2022_2,
                      rows = 52,
                      cols = 10,
                      unique_values = list(
                        `Country` = 52
  ...
  ## WMR2022A Assertions: ####
  check_who_dataframe(df = wmr2022a,
                      rows = 89,
                      cols = 19,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2022B Assertions: ####
  check_who_dataframe(df = wmr2022b,
                      rows = 90,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2022C Assertions: ####
  check_who_dataframe(df = wmr2022c,
                      rows = 267,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2022D Assertions: ####
  check_who_dataframe(df = wmr2022d,
                      rows = 270,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2022ea,
                      rows = 31,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 4,
  ...
  check_who_dataframe(df = wmr2022eb,
                      rows = 21,
                      cols = 27,
                      unique_values = list(
                        `WHO Region` = 1,
  ...
  ## WMR2022G Assertions: ####
  check_who_dataframe(df = wmr2022g,
                      rows = 90,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2022I Assertions: ####
  check_who_dataframe(df = wmr2022i,
                      rows = 605,
                      cols = 15,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2021J Assertions: ####
  check_who_dataframe(df = wmr2022j,
                      rows = 96,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
