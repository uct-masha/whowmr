...
get_wmr2020 <- function() {
  ...
  ## WMR2020A Assertions: ####
  check_who_dataframe(df = wmr2020a,
                      rows = 90,
                      cols = 19,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2020B Assertions: ####
  check_who_dataframe(df = wmr2020b,
                      rows = 96,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2020C Assertions: ####
  check_who_dataframe(df = wmr2020c,
                      rows = 279,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2020D Assertions: ####
  check_who_dataframe(df = wmr2020d,
                      rows = 288,
                      cols = 9,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2020ea,
                      rows = 37,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 2,
  ...
  check_who_dataframe(df = wmr2020eb,
                      rows = 24,
                      cols = 27,
                      unique_values = list(
                        `WHO Region` = 1,
  ...
  ## WMR2020F Assertions: ####
  check_who_dataframe(df = wmr2020f,
                      rows = 2160,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2020G Assertions: ####
  check_who_dataframe(df = wmr2020g,
                      rows = 92,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2020H Assertions: ####
  check_who_dataframe(df = wmr2020h,
                      rows = 682,
                      cols = 13,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2020I Assertions: ####
  check_who_dataframe(df = wmr2020i,
                      rows = 624,
                      cols = 13,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2020J Assertions: ####
  check_who_dataframe(df = wmr2020j,
                      rows = 104,
                      cols = 12,
                      unique_values = list(
                        `WHO Region` = 6,
