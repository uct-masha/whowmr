...
get_wmr2021 <- function() {
  ...
  ## WMR2021A Assertions: ####
  check_who_dataframe(df = wmr2021a,
                      rows = 91,
                      cols = 19,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2021B Assertions: ####
  check_who_dataframe(df = wmr2021b,
                      rows = 91,
                      cols = 7,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2021C Assertions: ####
  check_who_dataframe(df = wmr2021c,
                      rows = 267,
                      cols = 16,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2021D Assertions: ####
  check_who_dataframe(df = wmr2021d,
                      rows = 285,
                      cols = 11,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2021ea,
                      rows = 41,
                      cols = 21,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  check_who_dataframe(df = wmr2021eb,
                      rows = 21,
                      cols = 27,
                      unique_values = list(
                        `WHO Region` = 1,
  ...
  ## WMR2021F Assertions: ####
  #
  check_who_dataframe(df = wmr2021f,
                      rows = 2289,
                      cols = 10,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2021G Assertions: ####
  check_who_dataframe(df = wmr2021g,
                      rows = 92,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 5,
  ...
  ## WMR2021I Assertions: ####
  check_who_dataframe(df = wmr2021i,
                      rows = 607,
                      cols = 14,
                      unique_values = list(
                        `WHO Region` = 6,
  ...
  ## WMR2021J Assertions: ####
  check_who_dataframe(df = wmr2021j,
                      rows = 104,
                      cols = 13,
                      unique_values = list(
                        `WHO Region` = 6,
